...
#define TEXT_XUNLEI_USER_NAME                                                  \
  _(" --lx-username=USERNAME       Set Xunlei account username.")
#define TEXT_XUNLEI_PASSWORD                                                  \
  _(" --lx-password=PASSWORD       Set Xunlei account password.")
